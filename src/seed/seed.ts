...
export const initialData: SeedData = {
  ...
  users: [
    { email: "ruben@google.com", password: bcryptjs.hashSync("123456"), name: "Ruben Seco", role: "admin" },
    { email: "isa@google.com", password: bcryptjs.hashSync("123456"), name: "Isabel Yegros", role: "user" },
  ],
